module github.com/i4de/iThings-demo

go 1.18

require (
	github.com/i-Things/things v0.2.0
	github.com/zeromicro/go-zero v1.4.2
)

replace (
	github.com/Masterminds/squirrel => github.com/i-Things/squirrel v1.20.1
	//github.com/i-Things/things => github.com/i4de/ithings v0.2.0
	github.com/i-Things/things => ../ithings
	github.com/taosdata/driver-go/v3 => github.com/i-Things/driver-go/v3 v3.10.3
)

require (
	github.com/Masterminds/squirrel v1.20.1 // indirect
